 ...
 * module variables
 */
I18n.prototype.localeCache = {};
I18n.prototype.resMethods = ['__', '__n', 'getLocale', 'isPreferredLocale'];
I18n.prototype.defaultLocale = 'en';
I18n.prototype.extension = '.json';
I18n.prototype.directory = './locales';
I18n.prototype.tags;
I18n.prototype.ctx;
		...
		self.tags.forEach(function(locale) {
			self.ctx.forEach(function(context) {
				...
				if (!utils.existsObj(self.localeCache, keyPath)) {
					var success = storage.read(locale.toLowerCase(), self.directory, context, self.localeCache, self.extension);
					if (!success) {
...
I18n.prototype.pathRewrite = function() {
	var self = this;
	return Translation.pathRewriteMiddleware(self);
};

I18n.prototype.urlTranslation = function() {
	var self = this;

	return function locUrlTranslation(req, res, next) {
...
I18n.prototype.getLocales = function() {
	...
	return storage.getLocales(this.directory, this.extension);
};
...
I18n.prototype.getContexts = function() {
	...
	else ctx = storage.getContexts(this.directory, this.contextSeparator);
...
I18n.prototype.write = function(locale, context, value) {
	...
	if (this.devMode) {
		...
		storage.write(locale, this.directory, context, this.localeCache, this.extension);
	}
};
